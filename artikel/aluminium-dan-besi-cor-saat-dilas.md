---
article_id: WLD-02-A05
title: "Aluminium dan Besi Cor: Dua Material yang Tidak Boleh Diperlakukan seperti Baja Biasa"
slug: "aluminium-dan-besi-cor-saat-dilas"
description: "Compare oxide, heat flow, cracking, cleanliness, porosity, casting condition, and when replacement is safer"
status: outline
publication_date: "2025-07-19"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: WLD-02
primary_intent: "Recognize special-material constraints"
reader_community: "Bengkel-las.co.id"
reader_address: "Sobat Bengkel-las.co.id"
final_route: "/artikel/aluminium-dan-besi-cor-saat-dilas.html"
...
# Aluminium dan Besi Cor: Dua Material yang Tidak Boleh Diperlakukan seperti Baja Biasa

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Aluminium dan Besi Cor: Dua Material yang Tidak Boleh Diperlakukan seperti Baja Biasa”
- **Reader and situation:** Repair buyer evaluating feasibility
- **Reader outcome:** Compare oxide, heat flow, cracking, cleanliness, porosity, casting condition, and when replacement is safer
- **Primary intent:** Recognize special-material constraints
...
- **Scope boundary:** Excludes step-by-step hazardous repair and production recipes; WLD-16-A06 owns repair triage
- **Final public route:** `/artikel/aluminium-dan-besi-cor-saat-dilas.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Aluminium dan Besi Cor: Dua Material yang Tidak Boleh Diperlakukan seperti Baja Biasa**.
...
- **Exact Markdown to insert:** `![Ilustrasi cat material besi](/wp-content/uploads/2020/03/cat-material-besi.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `cat material besi` as relevant content media; no pixels were inspected.
...
- `WLD-02-A04` → `/artikel/stainless-steel-untuk-fabrikasi-las.html` — Stainless Steel untuk Fabrikasi Las: Jenis, Weldability, dan Risiko Kontaminasi
...
- **Tie back to this article:** Keep the explanation specific to “Aluminium dan Besi Cor: Dua Material yang Tidak Boleh Diperlakukan seperti Baja Biasa”.
