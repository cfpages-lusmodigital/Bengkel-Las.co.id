...
description: "Compare saw, shear, plasma, laser, oxy-fuel, grinding, and machining by material, thickness, tolerance, HAZ, cleanup, and volume"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Memilih Proses Potong dan Persiapan Tepi Sebelum Pengelasan”
- **Reader and situation:** Fabricator planning parts
- **Reader outcome:** Compare saw, shear, plasma, laser, oxy-fuel, grinding, and machining by material, thickness, tolerance, HAZ, cleanup, and volume
- **Primary intent:** Select edge-preparation route
...
- **Scope boundary:** Excludes service pricing and welding-process selection; cutting/CNC hubs own quotes and WLD-01-A02 owns welding
- **Final public route:** `/artikel/memilih-proses-potong-sebelum-las.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Memilih Proses Potong dan Persiapan Tepi Sebelum Pengelasan**.
...
- **Tie back to this article:** Keep the explanation specific to “Memilih Proses Potong dan Persiapan Tepi Sebelum Pengelasan”.
