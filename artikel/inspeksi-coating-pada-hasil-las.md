...
description: "Explain visual coverage, edges/welds, dry-film-thickness concept, instrument checks, holiday questions, records, and repair areas"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Memeriksa Coating pada Hasil Las: DFT, Coverage, Edge, dan Titik Sulit”
- **Reader and situation:** Owner receiving painted fabrication
- **Reader outcome:** Explain visual coverage, edges/welds, dry-film-thickness concept, instrument checks, holiday questions, records, and repair areas
- **Primary intent:** Verify finished coating
...
- **Scope boundary:** Excludes universal acceptance values and warranty claims; coating specification/manufacturer owns criteria
- **Final public route:** `/artikel/inspeksi-coating-pada-hasil-las.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Memeriksa Coating pada Hasil Las: DFT, Coverage, Edge, dan Titik Sulit**.
...
- **Tie back to this article:** Keep the explanation specific to “Memeriksa Coating pada Hasil Las: DFT, Coverage, Edge, dan Titik Sulit”.
