...
description: "Explain defect and rework coding, first-pass yield concept, material loss, labor, energy, Pareto, containment, experiment, and sustainment"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Mengurangi Scrap dan Rework di Bengkel Las dengan Mengukur Penyebab”
- **Reader and situation:** Workshop manager tracking waste
- **Reader outcome:** Explain defect and rework coding, first-pass yield concept, material loss, labor, energy, Pareto, containment, experiment, and sustainment
- **Primary intent:** Improve process using defect data
...
- **Scope boundary:** Excludes invented benchmarks and blaming welders without root-cause evidence
- **Final public route:** `/artikel/mengurangi-scrap-dan-rework-las.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mengurangi Scrap dan Rework di Bengkel Las dengan Mengukur Penyebab**.
...
- **Tie back to this article:** Keep the explanation specific to “Mengurangi Scrap dan Rework di Bengkel Las dengan Mengukur Penyebab”.
