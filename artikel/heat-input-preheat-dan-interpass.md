...
description: "Explain why energy, travel, starting temperature, interpass limits, thickness, composition, and restraint affect outcomes"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Heat Input, Preheat, dan Interpass: Konsep Termal Tanpa Angka Tebakan”
- **Reader and situation:** Supervisor reviewing a procedure
- **Reader outcome:** Explain why energy, travel, starting temperature, interpass limits, thickness, composition, and restraint affect outcomes
- **Primary intent:** Understand thermal controls
...
- **Scope boundary:** Excludes prescribing temperatures or formulas as approval; qualified WPS and WLD-02-A03 own metallurgy basis
- **Final public route:** `/artikel/heat-input-preheat-dan-interpass.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Heat Input, Preheat, dan Interpass: Konsep Termal Tanpa Angka Tebakan**.
...
- `WLD-08-A01` → `/artikel/membaca-parameter-pengelasan-dari-wps.html` — Arus, Tegangan, Wire Feed, dan Travel Speed: Membaca Parameter dari WPS
...
- **Tie back to this article:** Keep the explanation specific to “Heat Input, Preheat, dan Interpass: Konsep Termal Tanpa Angka Tebakan”.
