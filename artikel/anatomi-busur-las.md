...
description: "Show how source, electrode/torch, arc, workpiece, return lead, current, voltage, AC/DC, and polarity relate"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Anatomi Busur Las: Arus, Tegangan, Polaritas, dan Jalur Arus”
- **Reader and situation:** Learner confused by electrical terms
- **Reader outcome:** Show how source, electrode/torch, arc, workpiece, return lead, current, voltage, AC/DC, and polarity relate
- **Primary intent:** Understand the welding electrical circuit
...
- **Scope boundary:** Excludes electrical K3 and return-path hazards, owned by WLD-04-A02, and excludes setting values, owned by WLD-08-A01
- **Final public route:** `/artikel/anatomi-busur-las.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Anatomi Busur Las: Arus, Tegangan, Polaritas, dan Jalur Arus**.
...
- **Tie back to this article:** Keep the explanation specific to “Anatomi Busur Las: Arus, Tegangan, Polaritas, dan Jalur Arus”.
