...
description: "Explain kerf, taper, dross, roughness concept, HAZ, heat distortion, measurement, and downstream welding implications"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Kerf, Heat-Affected Zone, dan Edge Quality pada Pemotongan Termal”
- **Reader and situation:** Designer or fabricator receiving cut parts
- **Reader outcome:** Explain kerf, taper, dross, roughness concept, HAZ, heat distortion, measurement, and downstream welding implications
- **Primary intent:** Specify thermally cut edge quality
...
- **Scope boundary:** Excludes acceptance numbers without drawing/specification and excludes weld HAZ metallurgy, owned by WLD-02-A03
- **Final public route:** `/artikel/kerf-haz-dan-kualitas-tepi-potong.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kerf, Heat-Affected Zone, dan Edge Quality pada Pemotongan Termal**.
...
- **Tie back to this article:** Keep the explanation specific to “Kerf, Heat-Affected Zone, dan Edge Quality pada Pemotongan Termal”.
