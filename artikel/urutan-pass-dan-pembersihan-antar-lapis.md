...
description: "Explain bead sequence, layer cleaning, visual checks, start/stop treatment, interpass control, and when to stop"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Urutan Pass dan Pembersihan Antar-Lapis pada Las Multi-Pass”
- **Reader and situation:** Welder or inspector on thicker joints
- **Reader outcome:** Explain bead sequence, layer cleaning, visual checks, start/stop treatment, interpass control, and when to stop
- **Primary intent:** Control multi-pass execution
...
- **Scope boundary:** Excludes changing bead sequence beyond the approved procedure; WLD-09-A03 owns inspection planning
- **Final public route:** `/artikel/urutan-pass-dan-pembersihan-antar-lapis.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Urutan Pass dan Pembersihan Antar-Lapis pada Las Multi-Pass**.
...
- **Tie back to this article:** Keep the explanation specific to “Urutan Pass dan Pembersihan Antar-Lapis pada Las Multi-Pass”.
